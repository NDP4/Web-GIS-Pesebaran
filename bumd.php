...
<head>
    ...
    <title>BUMD - Website Pemerintah Kabupaten Bantul</title>
        ...
        <section id="page-title">
            <div class="container clearfix">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> BUMD</li>
                </ol>
            </div>
        </section>
        <section id="content">
                        ...
                        <div class="col-md-9">
                            <table class="table table-responsive table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>YULI BUDI SASANGKA, ST</td>
                                        <td>Direktur PD. Aneka Dharma</td>
                                        <td>Jl. Jend. Sudirman, Bantul 55711 <br /> Telp. 0274 367 123</td>
                                        <td><a href="https://anekadharma.co.id" target="_blank">https://anekadharma.co.id</a></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>BAMBANG SURYO WIBOWO, S.E.</td>
                                        <td>Direktur Utama PT. BPR Bank Bantul</td>
                                        <td>Jl. Gajah Mada No. 3, Bantul 55167 <br /> Telp. 0274-367422</td>
                                        <td><a href="https://bankbantul.co.id/" target="_blank">https://bankbantul.co.id/</a></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>ARINTO HENDRO BUDIANTORO</td>
                                        <td>Direktur PDAM Bantul</td>
                                        <td>Jl. Dr. Wahidin Sudiro Husodo No. 83 Bantul <br /> Telp. 0274-367524</td>
                                        <td><a href="https://pdambantul.com" target="_blank">https://pdambantul.com</a></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>HETTY WIDIASTUTI, SE, MM</td>
                                        <td>Pemimpin Cabang BPD DIY Cabang Bantul</td>
                                        <td>Jl. Jenderal Sudirman No. 2a Bantul <br /> Telp. 0274-367011</td>
                                        <td><a href="http://bpddiy.co.id" target="_blank">http://bpddiy.co.id</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="sidebar nobottommargin col_last clearfix">
                            <div class="sidebar-widgets-wrap">
                                <div id="shortcodes" class="widget widget_links clearfix">
                                    ...
                                    <ul>
                                        <li><a href="bupati.php">
                                                <div>Bupati & Wakil Bupati</div>
                                            </a></li>
                                        <li><a href="forkopimda.php">
                                                <div>Forkopimda</div>
                                            </a></li>
                                        <li><a href="stafahli.php">
                                                <div>Staf Ahli Bupati</div>
                                            </a></li>
                                        <li><a href="perangkat.php">
                                                <div>Perangkat Daerah</div>
                                            </a></li>
                                        <li><a href="kapanewon.php">
                                                <div>Kapanewon / Kecamatan</div>
                                            </a></li>
                                        <li><a href="bumd.php">
                                                <div>BUMD</div>
                                            </a></li>
                            ...
                            <div class="widget clearfix" style="margin-bottom: -30px; margin-top: -20px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottommargin-sm">
                                        ...
                                        <div class="counter counter-small"><span data-from="0" data-to="8973956" data-refresh-interval="80" data-speed="3000" data-comma="true"></span></div>
                                    ...
                                    <div class="col-lg-6 bottommargin-sm">
                                        ...
                                        <div class="counter counter-small"><span data-from="0" data-to="12286" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
