                ...
                <div class="container clearfix">
                    <div class="postcontent nobottommargin clearfix">
                        <div id="snav-content1" style="text-align:justify;">
                            <h3>Visi Misi Kabupaten Bantul</h3>
                            <a href="https://bantulkab.go.id/resource/doc/images/users/default_image.jpg" target="_blank">
                            </a>
                            <p align="justify">
                            <p><img alt="" src="https://bantulkab.go.id/resource/temp/gambar_berita_detail/Visi_Misi_1.jpg" style="height:415px; width:415px" /><img alt="" src="https://bantulkab.go.id/resource/temp/gambar_berita_detail/Visi_Misi_2.jpg" style="float:right; height:415px; width:415px" /></p>

                            <p>&nbsp;</p>

                            <p><strong>A. VISI</strong></p>

                            <p>Terwujudnya Masyarakat Kabupaten Bantul yang harmonis, sejahtera dan berkeadilan berdasarkan Pancasila dan UUD 1945 dalam bingkai NKRI yang ber-Bhinneka Tunggal Ika.</p>
                            ...
                            <ol>
                                <li>Penguatan reformasi birokrasi menuju pemerintahan yang efektif, efisien, bersih, akuntabel dan menghadirkan pelayanan publik prima</li>
                                <li>Pengembangan sumber daya manusia unggul, berkarakter dan berbudaya istimewa</li>
                                <li>Pendayagunaan potensi lokal dengan penerapan teknologi dan penyerapan investasi berorientasi pada pertumbuhan ekonomi inklusif</li>
                                <li>Peningkatan kualitas lingkungan hidup, infrastruktur dan pengelolaan risiko bencana</li>
                                <li>Penanggulangan masalah kesejahteraan sosial secara terpadu dan pencapaian Bantul sebagai kabupaten layak anak, ramah perempuan dan difabel.&nbsp;</li>
                            </ol>
                            </p>
                        </div>
                    </div>
