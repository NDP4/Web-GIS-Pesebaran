...
<head>
    ...
    <title>Staf Ahli Bupati - Website Pemerintah Kabupaten Bantul</title>
...
============================================= -->
        ...
        <section id="page-title">
            <div class="container clearfix">
                <h1>Profil Staf Ahli</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Profil</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Staf Ahli</li>
                </ol>
            </div>
        </section>
        <section id="content">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-9">
                            <table class="table table-responsive table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Drs. KURNIANTARA, M.Si.</td>
                                        <td>Staf Ahli Bupati Bidang Politik, Hukum dan Pemerintahan</td>
                                        <td>Jl. Robert Wolter Monginsidi No. 1, Bantul 55711 <br /> Telp. 0274 367 509</td>
                                        <td><a href="https://setda.bantulkab.go.id" target="_blank">https://setda.bantulkab.go.id</a></td>
                                    </tr>
                                    <tr>
                                        <td>YULIUS SUHARTA, S.Sos., M.Si.</td>
                                        <td>Staf Ahli Bupati Bidang Sumber Daya Manusia dan Kemasyarakatan</td>
                                        <td>Jl. Robert Wolter Monginsidi No. 1, Bantul 55711 <br /> Telp. 0274 367 509</td>
                                        <td><a href="https://setda.bantulkab.go.id" target="_blank">https://setda.bantulkab.go.id</a></td>
                                    </tr>
                                    <tr>
                                        <td>YUS WARSENO, S.Pi., M.Sc.</td>
                                        <td>Staf Ahli Bupati Bidang Ekonomi, Keuangan dan Pembangunan</td>
                                        <td>Jl. Robert Wolter Monginsidi No. 1, Bantul 55711 <br /> Telp. 0274 367 509</td>
                                        <td><a href="https://setda.bantulkab.go.id" target="_blank">https://setda.bantulkab.go.id</a></td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="sidebar nobottommargin col_last clearfix">
                            <div class="sidebar-widgets-wrap">
                                <div id="shortcodes" class="widget widget_links clearfix">
                                    <h4>Profil</h4>
                                    <ul>
                                        <li><a href="https://bantulkab.go.id/bupati.html">
                                                <div>Bupati & Wakil Bupati</div>
                                            </a></li>
                                        <li><a href="https://bantulkab.go.id/forkopimda.html">
                                                <div>Forkopimda</div>
                                            </a></li>
                                        <li><a href="https://bantulkab.go.id/staf_ahli.html">
                                                <div>Staf Ahli Bupati</div>
                                            </a></li>
                                        <li><a href="https://bantulkab.go.id/perangkat_daerah.html">
                                                <div>Perangkat Daerah</div>
                                            </a></li>
                                        <li><a href="https://bantulkab.go.id/kecamatan.html">
                                                <div>Kapanewon / Kecamatan</div>
                                            </a></li>
                                        <li><a href="https://bantulkab.go.id/bumd.html">
                                                <div>BUMD</div>
                                            </a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="widget clearfix" style="margin-bottom: -30px; margin-top: -20px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 bottommargin-sm">
                                        ...
                                        <div class="counter counter-small"><span data-from="0" data-to="8973971" data-refresh-interval="80" data-speed="3000" data-comma="true"></span></div>
                                    ...
                                    <div class="col-lg-6 bottommargin-sm">
                                        ...
                                        <div class="counter counter-small"><span data-from="0" data-to="12301" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
